...
import com.inventory_management.filter.AuthFilter;
...
public class SecurityConfig {
    ...
    @Bean
    public AuthFilter authFilter(UserDetailsService userDetailsService, JwtService jwtService){
        return new AuthFilter(userDetailsService, jwtService);
    }
}
