...
const HomeHeader = () => {
  return (
    <nav className='fixed w-full z-20 top-0 start-0 bg-transparent opacity-70'>
        <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-8 px-5'>
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <a href="/login" className='bg-transparent px-4 py-2 text-white border-2 border-sky-200 hover:ring-2 rounded-lg'>Sign In</a>
            </div>
        </div>
    </nav>
  )
