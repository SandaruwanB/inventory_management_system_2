...
const Inventory = () => {
    ...
    const deleteProduct = async (id) => {
        ...
        await axios.delete(`${apiConfig.url}/api/inventory/delete/${id}`).then((result) => {
            if (result.status === 200) {
                ...
                setFilteredInventory(remainingProducts);
            }
        }).catch(err => {
    ...
    const handleSearch = (e) => {
        ...
        if (query === "") {
            ...
            setFilteredInventory(inventory.filter(item => item.prodctname.toLowerCase().includes(query)));
        }
    };
                    ...
                    <div className='w-full'>
                        ...
                        <div className='w-full mt-10'>
                            <div className='w-full flex justify-between'>
                                ...
                                <div className='flex'>
                                    <div className='text-gray-800 '>
                                        showing results <span className='text-blue-950 font-bold'>{filteredInventory.length}</span>
                                    </div>
                                </div>
                            </div>
                            <div className='grid lg:grid-cols-8 gap-5 mt-5 w-full md:grid-cols-3 sm:grid-cols-2 grid-cols-1'>
                                ...
                                {
                                    filteredInventory.map((value, index) => {
                                        return (
