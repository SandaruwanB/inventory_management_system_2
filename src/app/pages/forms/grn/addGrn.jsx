...
const AddGrn = () => {
  ...
  const addNewItem = async () => {
    if (product === 0 || count === "") {
      ...
      await axios
        .get(`${apiConfig.url}/api/inventory/get/${product}`, {
            headers : {
                Authorization : token
            }
        })
        .then((result) => {
          const array = {
            product: {
              ...
              availability:
                result.data.onhandqty > 20 ? "available" : "low stock",
  ...
  const addGrn = async () => {
    if (suplier === 0 || date === "") {
      ...
      await axios
        .post(`${apiConfig.url}/api/grn/add`, {
          grncode: grncode,
          date: date,
          note: note,
          suplier: {
        ...
        .then((result) => {
          if (result.status === 200) {
            ...
            setGrncode(
              "GRN" + Math.floor(Math.random() * (99999 - 10000) + 10000)
            );
            setSuplier(0);
            setNote("");
            setSelected([]);
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4">
          <div className="w-full">
            <h1 className=" mb-4 text-2xl text-gray-800 font-semibold">
              <span
                className="text-md text-blue-950 hover:underline cursor-pointer"
                onClick={() => navigate("/user/grn")}
              >
                GRN
              </span>{" "}
              / Add
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                      <div className="w-full px-3">
                        <input
                          ...
                          value={grncode}
                          className="appearance-none block uppercase text-4xl w-full text-gray-700 py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                          type="text"
                          readOnly
                        />
                      </div>
            ...
            <h1 className="font-semibold text-gray-700 mt-2">
              Products Details
            </h1>
            <div className="w-full bg-gray-400 h-[2px]"></div>
            <div className="w-100">
              <table className="w-full table-fixed border-collapse mt-3">
                <thead className="bg-gray-200 border-b-2 border-gray-400">
                  <tr>
                    <th className="p-1 text-sm font-semibold tracking-wide text-left pl-5">
                      Product
                    </th>
                ...
                <tbody>
                  {selected.map((value, index) => (
                    <tr key={index}>
                      ...
                      <td className="p-1 text-sm font-semibold tracking-wide text-left">
                        {value.quantity}
                      </td>
                      <td className="p-1 text-sm font-semibold tracking-wide text-center">
              ...
              <div className="text-center w-full">
                <div
                  className="text-center w-full text-blue-800 hover:underline cursor-pointer text-md p-3"
                  colSpan={4}
                >
              ...
              <div className="mt-10 w-100">
                ...
                <button
                  onClick={() => navigate("/user/grn")}
                  className="ml-4 bg-gray-700 hover:bg-gray-900 px-4 py-2 text-white rounded"
                >
                  Cancel
                </button>
              </div>
            ...
            <div className="w-full">
              ...
              <div className="mt-5 flex justify-end">
                ...
                <button
                  ...
                  className="ml-4 bg-gray-600 text-white text-sm px-3 py-1 rounded hover:bg-gray-800"
                >
                  Cancel
                </button>
              </div>
