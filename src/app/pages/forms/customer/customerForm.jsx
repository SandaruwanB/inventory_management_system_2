        ...
        <div className="p-4 sm:ml-64">
            <div className="p-4">
                <div className='w-full'>
                    <h1 className=' mb-4 text-2xl text-gray-800 font-semibold'><span className='text-md text-blue-950 hover:underline cursor-pointer' onClick={()=>navigate("/user/customers")}>Customers</span> / Add</h1>
                    <h1 className='font-semibold text-gray-700 mt-10'>Add new customer</h1>
                            ...
                            <div className='grid md:grid-cols-2 grid-cols-1 gap-2'>
                                ...
                                <div className='w-full max-w-lg'>
                                    ...
                                    <div className="flex flex-wrap w-full -mx-3 mb-6">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <button className='bg-blue-700 hover:bg-blue-900 px-4 py-2 text-white rounded' onClick={()=>addCustomer()}>Save</button>
