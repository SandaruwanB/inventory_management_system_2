        ...
        if (date === "" || customer === 0){
            ...
            await axios.post(`${apiConfig.url}/api/orders/add`, {
                ...
                if (result.status === 200){
                    ...
                    setTimeout(() => {
                        navigate(`/user/customer/orders/edit/${result.data.id}`);
                    }, 500);
                }
            }).catch(error => {
        ...
        <div className="p-4 sm:ml-64">
            <div className="p-4">
                <div className='w-full'>
                    <h1 className=' mb-4 text-2xl text-gray-800 font-semibold'><span className='text-md text-blue-950 hover:underline cursor-pointer' onClick={()=>navigate("/user/customer/orders")}>Orders</span> / </h1>
                    ...
                    <div className='w-100'>
                        ...
                        <div className='mt-10 w-100'>
                            ...
                            <button onClick={()=>navigate('/user/customer/orders')} className='ml-4 bg-gray-700 hover:bg-gray-900 px-4 py-2 text-white rounded'>Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
